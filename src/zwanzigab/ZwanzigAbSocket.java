...
import zwanzigab.messages.LoginError;
 ...
 */
@WebSocket
class ZwanzigAbSocket {

    public static final String PROP_CONNECTED = "connected";
    public static final String PROP_LOGOFF = "logoff";
    public static final String PROP_MESSAGE = "message";

    private static final Logger LOGGER = LogManager.getLogger(ZwanzigAbSocket.class);
    ...
    private void onLogin(JsonObject jsonObj) {
        ...
        if (validateLoginData(name, pwd)) {
            ZwanzigAbPlayer player = game.getPlayer(name);
            String successMessage = gson.toJson(new LoginSuccess(game.getVideoRoomName()));
            if (player == null) {
                player = new ZwanzigAbPlayer(name, this);
