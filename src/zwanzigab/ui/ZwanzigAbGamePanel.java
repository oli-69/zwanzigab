...
import zwanzigab.ZwanzigAbGame;
 ...
 * Editor.
 */
public class ZwanzigAbGamePanel extends GamePanel {

    private static final Logger LOGGER = LogManager.getLogger(ZwanzigAbGamePanel.class);
    private static final long serialVersionUID = 1L;

    DefaultListModel<Player> playerListModel;
    ZwanzigAbGame game;

    public ZwanzigAbGamePanel() {
        this(new ZwanzigAbGame());
    }

    public ZwanzigAbGamePanel(ZwanzigAbGame game) {
        this.game = game;
        initComponents();
